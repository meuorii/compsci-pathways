          ...
          <div className="relative group w-full max-w-sm p-12 rounded-2xl bg-[#1F1F2E]/80 backdrop-blur-md shadow-xl border border-[#3B82F6]/30 hover:border-[#3B82F6] transition-all duration-500 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center relative z-10">
              <motion.button
                ...
                className="px-8 py-3 rounded-lg font-semibold bg-gradient-to-r from-[#3B82F6] to-[#2563EB] hover:from-[#2563EB] hover:to-[#1E40AF] transition shadow-lg hover:shadow-[0_0_20px_#3B82F6]"
              >
                Enroll Now
              </motion.button>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                transition={{ type: "spring", stiffness: 250, damping: 15 }}
                className="px-8 py-3 rounded-lg font-semibold border border-[#3B82F6] text-[#3B82F6] hover:bg-[#3B82F6] hover:text-white transition shadow-md"
              >
                Learn More
              </motion.button>
            </div>
