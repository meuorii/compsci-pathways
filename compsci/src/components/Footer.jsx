...
const Footer = () => {
  return (
    ...
    >
          ...
          <div className="flex justify-center md:justify-start gap-5">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-11 h-11 flex items-center justify-center rounded-full border border-[#3B82F6]/60 text-[#60A5FA] hover:text-white hover:border-[#3B82F6] hover:shadow-[0_0_20px_#3B82F6] hover:scale-110 transition-all duration-300"
              >
                {item.icon}
              </a>
            ))}
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[#3B82F6]/20 pt-6 text-center text-gray-500 text-sm">
